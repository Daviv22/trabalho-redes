...
os.makedirs("graficos_latencia", exist_ok=True)
os.makedirs("graficos_saltos", exist_ok=True)

# =====================================================
# FUNÇÃO GENÉRICA
# =====================================================

def plotar(df, continente, site, coluna, ylabel, pasta):
    ...
    for (pais, ip), grupo in filtro.groupby(["pais", "ip"]):
    ...
    nome = os.path.join(
        pasta,
        f"{continente}_{site}.png".replace(" ", "_")
    )
...
print()
print("===================================")
print("Gráficos de latência gerados.")
print("Gráficos de saltos gerados.")
print("===================================")